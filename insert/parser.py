...
tokens = keywords + (
    'SPACE', 'LPAREN', 'RPAREN', 'NAME', #'VALUE_LIST', 'ASSIGNMENT_LIST', 'COLUMN', 'VALUE_LIST',
    #'VALUE', 'ASSIGNMENT', 
)
...
def p_statement_query(p):
    'statement : INSERT SPACE INTO SPACE tblname SPACE insertoption'
    # "statement : tblname"
...
def p_value_list(p):
    'valuelist : VALUES SPACE LPAREN NAME RPAREN'
